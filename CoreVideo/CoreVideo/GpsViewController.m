...
@property (weak) IBOutlet NSTextField *longitudeUnitLabel;//ns
@property (weak) IBOutlet NSImageView *northAngleImageView;//move
@property (weak) IBOutlet NSImageView *stillImageView;//still
